...
<body>
    <div class="container">
        ...
        <div class="row bg-dark ">
            <div class="col-lg-12">
                <h2 class="text-danger text-center">Ürünlerimiz</h2>
            </div>
            <!--Ürünlerimiz Başlığı-->
        </div>
        ...
        <div class="row ">
            <div class="col-lg-4  bg-dark">
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top"
                        src="https://www.musik-produktiv.com/pic-010107419xxl/fender-custom-shop-masterbuilt-59-stratocaster.jpg"
                        alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col-lg-4  bg-dark">
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top"
                        src="https://www.stars-music.com/medias/gibson/custom-shop-les-paul-standard-1959-hd-2-144189.png"
                        alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col-lg-4  bg-dark">
                <div class="card" style="width: 18rem;"">
        <img class=" card-img-top" src="https://m.media-amazon.com/images/I/71-Dmi7vNeL._AC_SX355_.jpg"
                    alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">DW Drum Workshop Satin 5</h5>

                        <a href="#" class="btn btn-primary">4700$</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4  bg-dark">
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top"
                        src="https://sc1.musik-produktiv.com/pic-010112040xxl/tama-imperialstar-22-hairline-blue-complete-drum-set-ie62h6w-hlb.jpg"
                        alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col-lg-4  bg-dark">
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top"
                        src="https://productimages.hepsiburada.net/s/8/550/9040878764082.jpg/format:webp"
                        alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col-lg-4  bg-dark">
                <div class="card" style="width: 18rem;"">
        <img class=" card-img-top"
                    src="https://media.mydukkan.com/image/33264/thmb_900x900_Kinglos.KinglosAdvancedViolinKLVP03A33264.jpg"
                    alt="Card image cap">
                    <div class="card-body">
